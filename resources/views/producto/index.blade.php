                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-md-10">
                                    <x-filtro-busqueda :action="route('productos.index')" :records-per-page="$data->records_per_page" :filter="$data->filter" />
                                </div>

                                <!-- Derecha: Botón Nuevo Producto -->
                                @if (\App\Helpers\RoleHelper::isAuthorized('Productos.createProductos'))
                                    ...
                                    @foreach ($productos as $producto)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (\App\Helpers\RoleHelper::isAuthorized('Productos.updateProductos'))
                                                    <a href="{{ route('productos.edit', $producto->id) }}"
                                                        class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i>
                                                        Editar</a>
                                                @endif

                                                @if (\App\Helpers\RoleHelper::isAuthorized('Productos.deleteProductos'))
