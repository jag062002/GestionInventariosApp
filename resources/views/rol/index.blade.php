                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h3 class="card-title"><a href="{{ route('roles.create') }}" class="btn btn-sm btn-primary"><i
                                        class="bi bi-plus-circle"></i> Nuevo Rol</a></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('roles.destroy', $rol) }}" method="POST"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-sm btn-danger btn-eliminar"><i class="bi bi-trash"></i> Eliminar</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
