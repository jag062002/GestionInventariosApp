                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            @if (\App\Helpers\RoleHelper::isAuthorized('Rol.createRols'))
                                <h3 class="card-title"><a href="{{ route('roles.create') }}"
                                        class="btn btn-sm btn-primary"><i class="bi bi-plus-circle"></i> Nuevo Rol</a></h3>
                            @endif
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    @foreach ($roles as $rol)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (\App\Helpers\RoleHelper::isAuthorized('Rol.updateRols'))
                                                    <a href="{{ route('roles.edit', $rol->id) }}"
                                                        class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i>
                                                        Editar</a>
                                                @endif

                                                @if (\App\Helpers\RoleHelper::isAuthorized('Rol.deleteRols'))
