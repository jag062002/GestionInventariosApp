                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="row align-items-center justify-content-between">
                                ...
                                @if (\App\Helpers\RoleHelper::isAuthorized('Proveedores.createProveedores'))
                                    <div class="col-md-2 text-end">
                                        <a href="{{ route('proveedor.create') }}" class="btn btn-primary"><i
                                                class="bi bi-plus-circle"></i> Nuevo Proveedor</a>
                                        </a>
                                    </div>
                                @endif
                            </div>
                                    ...
                                    @foreach ($proveedores as $proveedor)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (\App\Helpers\RoleHelper::isAuthorized('Proveedores.updateProveedores'))
                                                    <a href="{{ route('proveedor.edit', $proveedor->id) }}"
                                                        class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i>
                                                        Editar</a>
                                                @endif

                                                @if (\App\Helpers\RoleHelper::isAuthorized('Proveedores.deleteProveedores'))
                        ...
                        {{ $proveedores->appends(request()->except('page'))->links('components.customPagination') }}
                    </div>
                </div>
            </div>
        </div>
